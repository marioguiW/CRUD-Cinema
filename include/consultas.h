...
// Exibe um menu de opções para consultas e solicita ao usuário que escolha uma opção.
int consultas()
{
    int optionConsultas;
    printf("@=============@ Consultas @===============@\n");
...
//Lê o nome de um filme fornecido pelo usuário e busca no arquivo "cinemaV0.txt" por filmes com o nome correspondente.
...
//Lê o nome de um cliente fornecido pelo usuário e busca no arquivo "clienteV0.txt".
